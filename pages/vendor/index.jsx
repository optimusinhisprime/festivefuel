  ...
  return (
    <Flex direction="column">
      ...
      <Flex mt={10} mb={10} direction="column" align="center">
        ...
        <Flex m={10} justify="center"  border='1px' borderColor='black.200' wrap="wrap">
          {eventList.map((event)=>{
              return (<Link key={event.name}  _hover={{ textDecoration: 'none' }}>
              <Flex p={2} border='1px' borderColor='gray.200' w={400} m={5} >
                  <Image w={100} src={event.logo}/>
                  <Flex  ml={3} direction="column" >
                    <Text mb={3} fontSize='lg'>{event.name}</Text>
